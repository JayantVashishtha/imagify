...
const Result = () => {
  ...
  return (
    ...
    {!isImageLoaded && 
    <div className='flex w-full max-w-xl bg-neutral-500 text-white text-lg p-0.5 mt-10 rounded-full'>
      ...
      <button type='submit' className='h-12 bg-zinc-900 px-10 sm:px-16 rounded-full'>Generate</button>
    </div>
    }
    {isImageLoaded && 
    <div className='flex gap-2 flex-wrap justify-center text-white text-lg p-0.5 mt-10 rounded-full'>
