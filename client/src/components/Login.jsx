...
const Login = () => {
  ...
  return (
    <div
    className='fixed top-0 left-0 right-0 bottom-0 backdrop-blur-sm bg-black/30 flex justify-center items-center'>
       ...
       className='relative bg-white p-10 rounded-xl text-slate-500'>
         ...
         <p className='text-md'>Welcome back Please sign in to continue</p>
         ...
         <img onClick={()=>setShowLogin(false)} className='absolute top-5 cursor-pointer' src={assets.cross_icon} alt="" />
       </motion.form>
    </div>
  )
}
