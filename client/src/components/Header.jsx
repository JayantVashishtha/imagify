...
const Header = () => {
  ...
  return (
    ...
    viewport={{once:true}}>
        ...
        <motion.h1 className='text-4xl maz-w=[300px] sm:text-7xl sm:max-w[590] mx-auto mt-10 text-center'>
        ...
        className='mt-5 text-neutral-600'>Generated images from Imagify</motion.p>
    </motion.div>
  )
}
